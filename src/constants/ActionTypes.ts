...
export const DELETE_QUESTION_REQUEST = 'DELETE_QUESTION_REQUEST' as const;
export const DELETE_QUESTION_SUCCESS = 'DELETE_QUESTION_SUCCESS' as const;
export const DELETE_QUESTION_FAILURE = 'DELETE_QUESTION_FAILURE' as const;
